...
<section>
    <div class="service-area">
        <div class="container">
            <h1 class="srv-title">CONTACT US</h1>
            <form action="">
                <div class="contact-form">
                    ...
                    <div class="contact-field">
                        <input type="text" name="website" class="contact-input" placeholder="Website">
                    </div>
                    <div class="contact-field">
                        <input type="text" name="phone" class="contact-input" placeholder="Phone (Optional)">
                    </div>
                    <div class="contact-field-textbox" id="scroll-hide">
